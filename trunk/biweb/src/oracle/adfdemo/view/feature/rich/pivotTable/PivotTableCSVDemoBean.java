/* $Header: dsstools/modules/dvt-faces-demo/src/oracle/adfdemo/view/feature/rich/pivotTable/PivotTableCSVDemoBean.java /main/5 2009/03/19 21:37:43 teclee Exp $ */
...
/**
 *  @version $Header: dsstools/modules/dvt-faces-demo/src/oracle/adfdemo/view/feature/rich/pivotTable/PivotTableCSVDemoBean.java /main/5 2009/03/19 21:37:43 teclee Exp $
 *  @author  dahmed
...
public class PivotTableCSVDemoBean {
    ...
    public void valueChanged(ValueChangeEvent e) {
        ...
        FacesContext context = FacesContext.getCurrentInstance();
        if (bLimitChanged) {
            afContext.addPartialTarget(context.getViewRoot().findComponent("demoTemplate:rowsetOptions"));
            afContext.addPartialTarget(context.getViewRoot().findComponent("demoTemplate:goodPT"));
        }
        if (isGraphEnabled())
            afContext.addPartialTarget(context.getViewRoot().findComponent("demoTemplate:goodGraph"));
    }
